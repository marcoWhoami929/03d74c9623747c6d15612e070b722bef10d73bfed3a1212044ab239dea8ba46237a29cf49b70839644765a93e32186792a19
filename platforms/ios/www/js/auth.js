$(document).ready(function() {
    ...
    var url = "http://192.168.1.118/matriz/auth.php?callback=?";
   //var url = "https://sanfranciscodekkerlab.com/matriz/auth.php?callback=?";
   ...
   //Funcion de registro
    ...
    $("#formProcesarSolicitud").click(function() {
        ...
        var dataString = "observacionesSolicitud=" + observaciones + "&observacionesProductos=" + observacionesProductos +"&listaProductos=" + listaProductos + "&sucursalElegida=" + sucursalElegida + "&nombreCliente=" + nombreCliente + "&idCliente=" + idCliente + "&solicitudProceso=";
