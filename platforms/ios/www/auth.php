...
if(isset($_POST['signup']))
{
	...
	else
	{
		...
		$q=mysqli_query($conn,"insert into `user` (`fechaRegistro`,`nombreCompleto`,`email`,`password`, `taller`, `telefono`, `celular`, `direccion`) values ('$date','$nombreCompleto','$email','$password','$taller','$telefono','$celular', '$direccion')");
		if($q)
		{
			echo "success";
		}
